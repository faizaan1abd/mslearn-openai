...
3. Update the configuration values to include the **endpoint** and **key** from the Azure OpenAI resource you created, as well as the model name that you deployed, `gpt-35-turbo-instruct`. Then save the file by right-clicking on the file from the left pane and hit **Save**
